...
```
firmware/    KMK firmware (code.py) + pin mapping notes
hardware/    KiCad schematic/PCB, STEP export, gerbers/
enclosure/   3D-printable case + top plate (STL/STEP/F3Z)
images/      Renders and schematic/PCB screenshots
